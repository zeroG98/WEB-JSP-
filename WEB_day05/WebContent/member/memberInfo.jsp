...
<body>
<div class="container">
<form class="form-inline" action="/WEB_day05/memberUpdate.do" method="post">
...
<c:if test="${dto!=null}">
	...
	<tr>
		<td colspan="2" class="text-center">
			...
			<input type="button" value="리스트" class="btn btn-secondary" onclick="location.href='/WEB_day05/memberList.do'"/>
		</td>
	</tr>
</table>
</form>
